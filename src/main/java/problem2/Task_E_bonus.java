  ...
  public static class ClosestCentroidMapper
    ...
    protected void setup(Context context) throws IOException, InterruptedException {
      ...
      while (StringUtils.isNotEmpty(line = reader.readLine())) {
        ...
        double y;
        try {
          x = Double.parseDouble(pointComponents[4]);
          y = Double.parseDouble(pointComponents[5]);
...
//      System.out.println("Using the combiner!!!");
      ...
      for(Text value: values) {
        ...
        double x = Double.parseDouble(datapointComponents[4]);
        double y = Double.parseDouble(datapointComponents[5]);
        xSum += x;
        ySum += y;
      }
