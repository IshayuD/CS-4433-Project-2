...
//        System.out.println("not parsable ints, skipped this line");
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (int i = 0; i < iterations; i++) {
      ...
      job.setMapperClass(Task_C.ClosestCentroidMapper.class);
      job.setReducerClass(Task_C.NewCentroidCalculatorReducer.class);
...
//    System.exit(job.waitForCompletion(true) ? 0 : 1);
    ...
    System.out.println("Task C Execution Time: " + (taskFEndTime - startTime)/1000.0 + " seconds.");
  }
